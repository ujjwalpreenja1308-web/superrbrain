      ...
      <Tabs defaultValue="profile">
        ...
        <TabsContent value="billing" className="mt-4 space-y-4">
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Basic AI citation monitoring</p>
                </div>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <CardContent className="flex flex-col flex-1 gap-4">
                <ul className="space-y-2 flex-1">
                  {[
                    ...
                    "Gap queue with content generation",
                    "Email reports",
                  ].map((f) => (
            ...
            {/* Pro */}
            <Card className="relative flex flex-col border-primary/30 bg-accent-bg hover:border-primary/60 transition-colors"
            ...
            >
              ...
              <CardContent className="flex flex-col flex-1 gap-4">
                <ul className="space-y-2 flex-1">
                  {[
                    "Unlimited monitored prompts",
                    "Hourly citation scans",
                    "All platforms including YouTube & X",
          ...
          <p className="text-xs text-muted-foreground">
            Paid plans launch soon. You'll be notified at {user?.email}.
          </p>
        </TabsContent>
      </Tabs>
    </div>
